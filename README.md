...
| :---------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | --------------------------------------------------------------------------------------------------------------------------- |
|      `[GET] /api/v1/drivers/ `      |                                                                                                                                  Retrieve the drivers based on the request query parameters (if there is any). The returned results will be in the array of driver json object.                                                                                                                                   | Support filtering the trips based on **available_status** by putting the filtered condition in the request query parameters |
