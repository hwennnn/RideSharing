...
| :---------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|      `[GET] /api/v1/drivers/ `      |                                                                                                                                  Retrieve the drivers based on the request query parameters (if there is any). The returned results will be in the array of driver json object.                                                                                                                                   |
...
|          API Endpoint           |                                                                                                                                                                                               Description                                                                                                                                                                                               |
| :-----------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|     `[GET] /api/v1/trips/ `     |                                                                                                                         Retrieve the trips based on the request parameters (if there is any) from the database. The returned results will be in the array of trip json object.                                                                                                                          |
