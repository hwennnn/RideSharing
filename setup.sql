...
-- Insert Driver Data
INSERT INTO Driver (FirstName, LastName, MobileNumber, EmailAddress, IdentificationNumber, CarLicenseNumber) VALUES ('Run Lin', 'Xiong', '6522222222', 'runlin@gmail.com', 'T12345678A', 'h124j451k32jj123f');
INSERT INTO Driver (FirstName, LastName, MobileNumber, EmailAddress, IdentificationNumber, CarLicenseNumber) VALUES ('Zhi Quan', 'Henry Ong', '6533333333', 'henryong@gmail.com', 'T11111111C', 'dbaa541bcc85bcb3a8');
INSERT INTO Driver (FirstName, LastName, MobileNumber, EmailAddress, IdentificationNumber, CarLicenseNumber) VALUES ('Ming Han', 'Vincent Tee', '6544444444', 'vincentminghan@gmail.com', 'T22222222B', 'agfahudsi142kj42');

-- Insert Trip Data
INSERT INTO Trip (PickupPostalCode, DropoffPostalCode, Progress) VALUES ('642678', '730022', 0);
UPDATE Trip SET PassengerID=1, DriverID=2, Progress = 2 WHERE TripID = 1;
INSERT INTO Trip (PickupPostalCode, DropoffPostalCode, Progress) VALUES ('111111', '222222', 0);
